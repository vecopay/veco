...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 VECO from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 10000 VECO in block rewards plus fees, but
        ...
        # Send 100 VECO with subtract fee from amount
        ...
        # Sendmany 100 VECO with subtract fee from amount
