...
* WebSocket: [https://github.com/VecoOfficial/insight-api-veco#web-socket-api](https://github.com/VecoOfficial/insight-api-veco#web-socket-api)
* API: [https://github.com/VecoOfficial/insight-api-veco#instantsend-transactions](https://github.com/VecoOfficial/insight-api-veco#instantsend-transactions)
...
By default, the Veco Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Veco Core daemon:
