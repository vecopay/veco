...
BTCPATH=/some/root/path/swamp.git
SIGPATH=/some/root/path/swamp-detached-sigs.git
...
[swamp/gitian.sigs](https://github.com/SwampOfficial/gitian.sigs/) repository, or if that's not possible to create a pull
request.
