...
This document provides guidelines for internationalization of the Veco Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `veco_en.ts` remains unchanged.
