    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Veco Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Veco Core"));
...
These denominations are 0.01 VECO, 0.1 VECO, 1 VECO and 10 VECO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://vecopay.atlassian.net/wiki/display/DOC/PrivateSend\">https://vecopay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Veco Core is shutting down...") + "<br /><br />" +
