    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Veco Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Veco Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Veco Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Veco Core help message to get a list with possible Veco Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Veco Core client") + " " + networkStyle->getTitleAddText();
